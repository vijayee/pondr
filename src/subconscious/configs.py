...
class InstanceConfig:
    ...
    # STRM ring buffer: how many recent step outputs (with provenance back to
    ...
    # (d_state=16). See docs/STRM-architecture-proposal.md §4.4.
    ring_capacity: int = 0
...
INSTANCE_CONFIGS: dict[str, InstanceConfig] = {
    ...
    "working_memory": InstanceConfig(
        ...
        ring_capacity=0,  # STRM ring buffer OFF by default (byte-identical to Phase 2c)
    ),
