...
- 50,000 each for Uncertainty Detector, Aspirational Model, Self-Model gates
- Oracle-labeled "is this a gap?", "should I commit?", "should I say I don't know?"
...
### Phase 2c: Working Memory Instance

**Goal:** Deploy the SSM instance that maintains continuous awareness.
...
5× instance gates + states (~12.5M total)	GPU	~0.05 GB
...
**4**	System knows when it doesn't know. "I don't have information about that." Prospective memory: "You asked me to remind you about X."
